...
* forge install openZeppelin/openzeppelin-contracts &#x20;
  * Ownable.sol
*   forge install [smartcontractkit](https://github.com/smartcontractkit)/[**chainlink**](https://github.com/smartcontractkit/chainlink) &#x20;
...
*/
        ...
        returns (bool)
    {
        ...
        if (src != msg.sender && allowance[src][msg.sender] != type(uint).max) {  //uint(-1) refactored to type(uint).max 
